                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="d-flex align-items-center">
                                            ...
                                            <a href="add-invoice.html" class="btn btn-greys me-2"><i class="fa fa-plus-circle me-1"></i>Move to Customer</a>
        ...
        <div class="modal-content">
            ...
            <form action="#">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="input-block mb-0">
                                ...
                                <input type="text" class="form-control" value="12 hr" placeholder="ICU Nursing Care" disabled>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-12">
                            <div class="input-block mb-0">
                                <label>Equipment Needed</label>
                                <input type="text" class="form-control" value="Oxygen Cylender" placeholder="ICU Nursing Care" disabled>
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" data-bs-dismiss="modal" class="btn btn-primary paid-continue-btn">Move to Customer List</button>
                </div>
            </form>
        </div>
    </div>
