                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="d-flex align-items-center">
                                            <a href="{{ route('add-customer') }}" class="btn btn-greys me-2"><i class="fa-regular fa-eye me-1"></i> View Details</a>
                                            <div class="dropdown dropdown-action">
                                                <a href="#" class=" btn-action-icon " data-bs-toggle="dropdown" aria-expanded="false"><i class="fas fa-ellipsis-v"></i></a>
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <ul>
                                                        <li>
                                                            <a href="{{ route('add-customer') }}" class="dropdown-item" href="javascript:void(0);"><i class="fa-regular fa-eye me-2"></i>View</a>
                                                        </li>
                                                        <li>
                                    ...
                                    <tr>
                                        ...
                                        <td>ICU Nursing Care</td>
                                        <td>12 hr</td>
                                        <td><span class="badge bg-warning-light text-warning">Ongoing</span></td>
                                        <td class="d-flex align-items-center">
