                                ...
                                <tbody>
                                    ...
                                    @foreach($customers as $customer)
                                        <tr>
                                            ...
                                            <td>
                                                @if($customer->work_status == 1)
                                                    <span class="badge bg-success-light">New Queries</span>
                                                @elseif($customer->work_status == 2)
                                                    <span class="badge bg-warning-light text-warning">Ongoing</span>
                                                @elseif($customer->work_status == 0)
                                            ...
                                            <td class="d-flex align-items-center">
                                                <a href="#" class="btn btn-greys me-2" data-bs-toggle="modal" data-bs-target="#view_vendor{{ $i }}">
                                                    <i class="fa-regular fa-eye me-1"></i> View Details
                                                </a>
                                                <a href="{{ route('customer.SessionMove', $customer->id) }}" onclick="return confirm('Are you sure you want to move this customer?');" class="btn btn-greys me-2">
                                                    <i class="fa fa-plus-circle me-1"></i>Move to Session Test List
                                                </a>
                                                ...
                                                <div class="modal custom-modal fade" id="view_vendor{{ $i }}" role="dialog">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <form action="#">
                                                                <div class="modal-body">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-12 col-md-12">
                                                                            <div class="input-block mb-0">
                                                                                <label>Message</label>
                                                                                <textarea type="text" class="form-control" value="{{ $customer->apt_message }}" disabled></textarea>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <a class="btn btn-primary paid-continue-btn" href="{{ route('customer.SessionMove', $customer->id) }}" onclick="return confirm('Are you sure you want to Move this Session List?');" >
                                                                    <i class="fa fa-plus-circle me-1"></i> Move to Session List
                                                                    </a>
                                                                </div>
                                                            </form>
                                                        </div>
