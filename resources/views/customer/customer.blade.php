                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-center table-hover datatable">
                                ...
                                <tbody>
                                    @php
                                        $count = 1; // Initialize count variabl
                                    @endphp
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex align-items-center">
                                            <a href="{{ route('view-customer', ['id' => $customer->id]) }}" class="btn btn-greys me-2">
                                            ...
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <ul>
                                                        <li>
                                                            <a href="{{ route('view-customer', ['id' => $customer->id]) }}" class="dropdown-item">
                                                                <i class="fa-regular fa-eye me-2"></i>View
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="{{ route('edit-customer', ['id' => $customer->id]) }}" class="dropdown-item">
                                                                <i class="fa-regular fa-eye me-2"></i>Edit
                                                            </a>
                                                        </li>
                                                        <li>
