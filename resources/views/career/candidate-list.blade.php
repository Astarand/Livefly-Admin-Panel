                                ...
                                <table class="table table-center table-hover datatable">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><span class="badge bg-success-light">Selected</span></td>
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        <li>
                                                            ...
                                                            <li>
                                                                ...
                                                                <a class="dropdown-item" href="deactive-customers.html"><i class="far fa-bell-slash me-2"></i>Selected</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge bg-danger-light">Reject</span></td>
                                            <td class="d-flex align-items-center">
                                                <a href="customers-ledger.html" class="btn btn-greys me-2" data-bs-toggle="modal" data-bs-target="#edit_vendor"><i class="fa-regular fa-eye me-1"></i> View Details</a>
                                                <div class="dropdown dropdown-action">
                                                    <a href="#" class=" btn-action-icon " data-bs-toggle="dropdown" aria-expanded="false"><i class="fas fa-ellipsis-v"></i></a>
            ...
            <div class="modal-content">
                <div class="modal-header border-0 pb-0">
                    <div class="form-header modal-header-title text-start mb-0">
                        <h4 class="mb-0">View Candidate Details</h4>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="input-block mb-0">
                                    ...
                                    <a href="#" class="btn btn-greys me-2 w-100"><i class="fa-regular fa-eye me-1"></i> View CV</a>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-12">
                                <div class="input-block mb-0">
                                    <label>Address Line 1</label>
                                    <input type="text" class="form-control" value="" placeholder="Enter Address Line 1" disabled>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-12">
                                <div class="input-block mb-0">
                                    <label>Address Line 2</label>
                                    <input type="text" class="form-control" value="" placeholder="Enter Address Line 2" disabled>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-12">
                                <div class="input-block mb-0">
                                    <label>City</label>
                                    <input type="text" class="form-control" value="" placeholder="Enter City" disabled>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-12">
                                <div class="input-block mb-0">
                                    <label>Pincode</label>
                                    <input type="text" class="form-control" value="" placeholder="Enter Pincode" disabled>
                                </div>
                            </div>
                        </div>
                    </div>
