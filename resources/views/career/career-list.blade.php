            ...
            <div class="content-page-header ">
                ...
                <div class="list-btn">
                    <ul class="filter-list">
                        ...
                        <li>
                            <a class="btn btn-primary" href="{{ route('add-career') }}"><i class="fa fa-plus-circle me-2" aria-hidden="true"></i>Add Career</a>
                        </li>
                    </ul>
                </div>
            </div>
                                    ...
                                    <tbody>
                                        @foreach($careers as $career)
                                            <tr>
                                                ...
                                                <td>{{ $career->status == 0 ? 'Active' : 'Deactive' }}</td>
                                                <td class="d-flex align-items-center">
                                                    <div class="dropdown dropdown-action">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <ul>
                                                                <li>
                                                                    <a class="dropdown-item" href="{{ route('career.edit', $career->id) }}"><i class="far fa-edit me-2"></i>Edit</a>
                                                                </li>
                                                                <li>
                                                                    {{-- <a class="dropdown-item" href="{{ route('career.deactive', $career->id) }}"   onclick="return confirm('Are You sure?')"><i class="far fa-trash-alt me-2"></i>Deactive</a> --}}
                                                                    @if($career->status == 0)
                                                                        <a class="dropdown-item" href="{{ route('career.deactive', $career->id) }}" onclick="return confirm('Are you sure you want to deactivate this career?')">
                                                                            <i class="far fa-edit me-2"></i> Deactivate
                                                                        </a>
                                                                    @else
                                                                        <a class="dropdown-item" href="{{ route('career.activate', $career->id) }}" onclick="return confirm('Are you sure you want to activate this career?')">
                                                                            <i class="far fa-check-circle me-2"></i> Activate
                                                                        </a>
                                                                    @endif
                                                                </li>
                                                            </ul>
