                ...
                <div class="content-page-header ">
                    ...
                    <div class="list-btn">
                        <ul class="filter-list">
                            ...
                            <li>
                                <a class="btn btn-primary" href="{{ route('add-nurse') }}"><i class="fa fa-plus-circle me-2" aria-hidden="true"></i>Add Nurse</a>
                            </li>
                        </ul>
                    </div>
                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @elseif($nurse->status == 2)
                                                    <span class="badge bg-warning-light">Serving</span>
                                                @else
                                                    <span class="badge bg-secondary-light">Unknown</span>
                                                @endif
                                            </td>


                                            <td class="d-flex align-items-center">
                                                <a href="customers-ledger.html" class="btn btn-greys me-2" data-bs-toggle="modal" data-bs-target="#view_vendor{{ $nurse->id }}"><i class="fa-regular fa-eye me-1"></i> View Details</a>
                                            ...
                                            <div class="modal custom-modal fade" id="view_vendor{{ $nurse->id }}" role="dialog">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-6 col-md-12">
                                                                        <div class="input-block mb-0">
                                                                            <label>Service Started From</label>
                                                                            <input type="date" class="form-control" 
       value="{{ $nurse->service_stared ? \Carbon\Carbon::parse($nurse->service_stared)->toDateString() : '' }}" 
       placeholder="Service Started From">

                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-6 col-md-12">
                                                                        <div class="input-block mb-0">
                                                                            <label>Service Given to</label>
                                                                            <input type="text" class="form-control" value="{{ $nurse->fname }} {{ $nurse->lname }}" placeholder="Enter Reference Number" disabled>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-6 col-md-12 mt-3">
                                                                        <div class="input-block mb-3">
                                                                            <label>Service Start Date</label>
                                                                            <input type="text" class="form-control" value="{{ $nurse->service_start_date }}" placeholder="Enter Reference Number" disabled>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-6 col-md-12 mt-3">
                                                                        <div class="input-block mb-0">
                                                                            <label>Service End Date</label>
                                                                            <input type="text" class="form-control" value="{{ $nurse->service_end_date }}" placeholder="Enter Reference Number" disabled>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-6 col-md-12 mt-3">
                                                                        <div class="input-block mb-0">
                                                                            <label>Address Line 1</label>
                                                                            <input type="text" class="form-control" value="{{ $nurse->address1 }}" placeholder="Address Line 1" disabled>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-6 col-md-12 mt-3">
                                                                        <div class="input-block mb-0">
                                                                            <label>Address Line 2</label>
                                                                            <input type="text" class="form-control" value="{{ $nurse->address2 }}" placeholder="Address Line 2" disabled>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-6 col-md-12 mt-3">
                                                                        <div class="input-block mb-0">
                                                                            <label>City</label>
                                                                            <input type="text" class="form-control" value="{{ $nurse->city }}" placeholder="Enter City" disabled>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-6 col-md-12 mt-3">
                                                                        <div class="input-block mb-0">
                                                                            <label>Pincode</label>
                                                                            <input type="text" class="form-control" value="{{ $nurse->pincode }}" placeholder="Enter Pincode" disabled>
                                                                        </div>
                                                                    </div>
                                                                    {{-- <div class="col-lg-12 col-md-12">
                                                                        <div class="input-block mb-0">
                                                                            <label>Message</label>
                                                                            <textarea type="text" class="form-control" value="{{ $nurse->address1 }}" placeholder="Enter Message" disabled></textarea>
                                                                        </div>
                                                                    </div> --}}
                                                                </div>
                                                            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge bg-warning-light text-warning">Serving</span></td>
                                            <td class="d-flex align-items-center">
                                                <a href="customers-ledger.html" class="btn btn-greys me-2" data-bs-toggle="modal" data-bs-target="#edit_vendor"><i class="fa-regular fa-eye me-1"></i> View Details</a>
                                                <div class="dropdown dropdown-action">
                                                    <a href="#" class=" btn-action-icon " data-bs-toggle="dropdown" aria-expanded="false"><i class="fas fa-ellipsis-v"></i></a>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge bg-danger-light">Not Avilable</span></td>
                                            <td class="d-flex align-items-center">
                                                <a href="customers-ledger.html" class="btn btn-greys me-2" data-bs-toggle="modal" data-bs-target="#edit_vendor"><i class="fa-regular fa-eye me-1"></i> View Details</a>
                                                <div class="dropdown dropdown-action">
                                                    <a href="#" class=" btn-action-icon " data-bs-toggle="dropdown" aria-expanded="false"><i class="fas fa-ellipsis-v"></i></a>
